...
\item 
class \textbf{ Iterator\+Generator}
\item 
...
\item 
auto \textbf{ acquire\+Generator\+Tracker} (\textbf{ String\+Ref} generator\+Name, \textbf{ Source\+Line\+Info} const \&line\+Info) -\/$>$ \textbf{ I\+Generator\+Tracker} \&
\item 
{\footnotesize template$<$typename L $>$ }\\auto \textbf{ generate} (\textbf{ String\+Ref} generator\+Name, \textbf{ Source\+Line\+Info} const \&line\+Info, L const \&generator\+Expression) -\/$>$ decltype(std\+::declval$<$ decltype(generator\+Expression())$>$().get())
\item 
...
\item 
{\footnotesize template$<$typename Func , typename U , typename T  = Function\+Return\+Type$<$\+Func, U$>$$>$ }\\\textbf{ Generator\+Wrapper}$<$ T $>$ \textbf{ map} (Func \&\&function, \textbf{ Generator\+Wrapper}$<$ U $>$ \&\&generator)
\item 
...
\item 
{\footnotesize template$<$typename T $>$ }\\\textbf{ Generator\+Wrapper}$<$ T $>$ \textbf{ range} (T const \&start, T const \&end, T const \&step)
\item 
{\footnotesize template$<$typename T $>$ }\\\textbf{ Generator\+Wrapper}$<$ T $>$ \textbf{ range} (T const \&start, T const \&end)
\item 
{\footnotesize template$<$typename Input\+Iterator , typename Input\+Sentinel , typename Result\+Type  = typename std\+::iterator\+\_\+traits$<$\+Input\+Iterator$>$\+::value\+\_\+type$>$ }\\\textbf{ Generator\+Wrapper}$<$ Result\+Type $>$ \textbf{ from\+\_\+range} (Input\+Iterator from, Input\+Sentinel to)
\item 
{\footnotesize template$<$typename Container , typename Result\+Type  = typename Container\+::value\+\_\+type$>$ }\\\textbf{ Generator\+Wrapper}$<$ Result\+Type $>$ \textbf{ from\+\_\+range} (Container const \&cnt)
\end{DoxyCompactItemize}
...
\doxysubsubsection{GeneratorBasePtr}
...
\mbox{\label{namespace_catch_1_1_generators_ac1fe3550c5f97370fc6729e04d7571b8}} 
...
{\footnotesize\ttfamily auto Catch\+::\+Generators\+::acquire\+Generator\+Tracker (\begin{DoxyParamCaption}\item[{\textbf{ String\+Ref}}]{generator\+Name,  }\item[{\textbf{ Source\+Line\+Info} const \&}]{line\+Info }\end{DoxyParamCaption}) -\/$>$  \textbf{ I\+Generator\+Tracker} \&}
...
\doxysubsubsection{from\_range()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename Container , typename Result\+Type  = typename Container\+::value\+\_\+type$>$ \\
\textbf{ Generator\+Wrapper}$<$Result\+Type$>$ Catch\+::\+Generators\+::from\+\_\+range (\begin{DoxyParamCaption}\item[{Container const \&}]{cnt }\end{DoxyParamCaption})}

\mbox{\label{namespace_catch_1_1_generators_a9d2acedb284b77addf4397c1c26918f3}} 
\index{Catch::Generators@{Catch::Generators}!from\_range@{from\_range}}
\index{from\_range@{from\_range}!Catch::Generators@{Catch::Generators}}
\doxysubsubsection{from\_range()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
...
\textbf{ Generator\+Wrapper}$<$Result\+Type$>$ Catch\+::\+Generators\+::from\+\_\+range (\begin{DoxyParamCaption}\item[{Input\+Iterator}]{from,  }\item[{Input\+Sentinel}]{to }\end{DoxyParamCaption})}

\mbox{\label{namespace_catch_1_1_generators_a3b0ab1f589b1d1e0e92afcd12cf4ab12}} 
...
auto Catch\+::\+Generators\+::generate (\begin{DoxyParamCaption}\item[{\textbf{ String\+Ref}}]{generator\+Name,  }\item[{\textbf{ Source\+Line\+Info} const \&}]{line\+Info,  }\item[{L const \&}]{generator\+Expression }\end{DoxyParamCaption}) -\/$>$ decltype(std\+::declval$<$decltype(generator\+Expression())$>$().get()) }
...
\doxysubsubsection{makeGenerators()\hspace{0.1cm}{\footnotesize\ttfamily [1/4]}}
...
\index{Catch::Generators@{Catch::Generators}!makeGenerators@{makeGenerators}}
\index{makeGenerators@{makeGenerators}!Catch::Generators@{Catch::Generators}}
\doxysubsubsection{makeGenerators()\hspace{0.1cm}{\footnotesize\ttfamily [2/4]}}
{\footnotesize\ttfamily template$<$typename T $>$ \\
...
\index{Catch::Generators@{Catch::Generators}!makeGenerators@{makeGenerators}}
\index{makeGenerators@{makeGenerators}!Catch::Generators@{Catch::Generators}}
\doxysubsubsection{makeGenerators()\hspace{0.1cm}{\footnotesize\ttfamily [3/4]}}
...
\mbox{\label{namespace_catch_1_1_generators_ab22ab581e83e71530d8bbd1c14f94abc}} 
\index{Catch::Generators@{Catch::Generators}!makeGenerators@{makeGenerators}}
\index{makeGenerators@{makeGenerators}!Catch::Generators@{Catch::Generators}}
\doxysubsubsection{makeGenerators()\hspace{0.1cm}{\footnotesize\ttfamily [4/4]}}
{\footnotesize\ttfamily template$<$typename T , typename... Gs$>$ \\
